...
class UpdateReservationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'reservation_date' => 'required|date|after_or_equal:tomorrow|before_or_equal:' . Carbon::today()->addMonths(3)->format('Y-m-d'),
    ...
    public function messages(): array
    {
        return [
            ...
            'reservation_date.after_or_equal' => 'Solo puedes modificar reservas con al menos 1 día de anticipación.',
